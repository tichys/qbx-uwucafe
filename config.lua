...
Config.Zones = {
    ...
    [8] = { coords = vector3(-706.06, -913.97, 19.22), radius = 0.8, icon = "fa-solid fa-basket-shopping", event = "qb-uwucafe:client:openShop", label = "UwU Shop", job = "uwu" },
    [9] = { coords = vector3(-589.35, -1068.52, 21.84), radius = 0.7, icon = "fa-solid fa-boxes-stacked", event = "qb-uwucafe:client:grabIce", label = "Ice Machine", job = "uwu" },
    [10] = { coords = vector3(-594.35, -1054.15, 23.04), radius = 0.6, icon = "fa-solid fa-martini-glass-citrus", event = "qb-uwucafe:clientToggleDuty", label = "Toggle Duty", job = "uwu" },
}
